...
<form action="#" name="smfaq-form" id="smfaq-form" method="post" >
	...
	<div class="titleform"><?php echo JText::_('COM_SMFAQ_TITLE_FORMqwee'); ?></div>
	<?php if ($user->guest) { 
	...
	?>
    <div class="clr"></div>
	<input type="button" class="button quest_btn" onclick="SmFaq.sendform(this.form)" value="<?php echo JText::_('COM_SMFAQ_SEND'); ?>" />
