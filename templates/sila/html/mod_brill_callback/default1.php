...
echo('<div class="ContactsForm">');
echo('<div class="ContactsFormColumn">');
echo('<div class="ContactsFormColumnInner _left">');
...
echo('<input type="text" name="name" id="brillcallback_name" placeholder="¬ведите им€*" class="Form__field field_effect> ');
