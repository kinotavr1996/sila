...
<textarea name="comment quest_form_txt"></textarea><br /><br />
<input type="hidden" name="token" value="<?php echo JSession::getFormToken(); ?>" />
<input type="hidden" name="id" value="<?php echo $this->id; ?>" />
<input type="button" class="button quest_btn" onclick="SmFaq.Comment(this.form)" value="<?php echo JText::_('COM_SMFAQ_SEND'); ?>" />