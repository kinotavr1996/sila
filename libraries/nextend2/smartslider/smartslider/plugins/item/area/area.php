...
class N2SSPluginItemArea extends N2SSPluginItemAbstract
{
    ...
    public function getTemplate($slider) {
        ...
        return '<span style="display:inline-block;vertical-align:top;width:{width};height:{height};background-color:{colora};opacity:{opacity};border:{borderWidth} solid {borderColora};border-radius:{borderRadius};-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;"></span>';
    }
    ...
    private function getHtml($data) {
        ...
        return NHtml::tag('span', array(
            'style' => 'display:inline-block;vertical-align:top;width:' . $width . ';height:' . $height . ';background-color:#' . $hex . ';background-color:' . $rgba . ';border:' . $borderWidth . 'px solid #' . $borderHex . ';border:' . $borderWidth . 'px solid ' . $borderRgba . ';border-radius:' . $borderRadius . 'px;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'
        ));
    }
