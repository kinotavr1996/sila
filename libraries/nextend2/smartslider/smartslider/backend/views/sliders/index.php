...
?>
    <div class="n2-ss-dashboard">
        ...
        n2GetBox('', 'Update.png', $versionsTXT . ($hasUpdate ? '<a href="' . $this->appType->router->createUrl(array(
                    'update/update',
                    N2Form::tokenizeUrl() + array('download' => 1)
                )) . '" class="n2-button n2-button-small n2-button-blue n2-uc n2-h5">' . n2_('Update') . '</a>' : '') . '<a href="' . $this->appType->router->createUrl(array(
                'update/check',
                N2Form::tokenizeUrl()
            )) . '" class="n2-button n2-button-small n2-button-blue n2-uc n2-h5">' . n2_('Check') . '</a>');
